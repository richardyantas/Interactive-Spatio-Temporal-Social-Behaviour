...
const char *vertexCircleSource = "#version 330 core\n"
...
void main()
{
    ...
    for (int i = 0; i <= num_sides; i++) {
        ...
        float ang = PI * 2.0 / float(num_sides) * i;
...
int main()
{
    ...
    int vertexCircleShader = glCreateShader(GL_VERTEX_SHADER);
    glShaderSource(vertexCircleShader, 1, &vertexCircleSource, NULL);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        _mat = glm::scale( _mat, glm::vec3( 1.5f, 1.5f, 1.0f ) );
        //glm::mat4 p = glm::ortho(0.0f, 800.0f, 0.0f, 600.0f, 0.1f, 1.0f);
        //_mat = _mat*p;
