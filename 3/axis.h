...
const unsigned int SCR_WIDTH_2 = 1000;
const unsigned int SCR_HEIGHT_2 = 600;
...
class axis
{
    ...
    axis(float x = 0.0f, float y = 0.0f, float z = 0.0f, float radius = 100.0f)
    {
        //pshader = new Shader("../particle.vs","../particle.fs","../particle.gs");
        pshader = new Shader("../axis.vs","../axis.fs");
        center = glm::vec3(( 1. / SCR_WIDTH_2 )*x,( 1. / SCR_HEIGHT_2 )*y, 0.0f );   // Transform from world to gl
        this->radius = ( 1. / SCR_WIDTH_2 ) * radius;                              // Transform from world to gl
    }
